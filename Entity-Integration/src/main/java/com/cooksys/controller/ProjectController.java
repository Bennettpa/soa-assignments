...
public class ProjectController {
	...
	public List<ProjectDto> getAllOverdue() {
		return projectService.getOverdueAll();
	}
	...
	public void addManagerAsManager(@PathVariable long projectId, @PathVariable long managerId) {
		projectService.addManager(projectId, managerId);
	}
}
